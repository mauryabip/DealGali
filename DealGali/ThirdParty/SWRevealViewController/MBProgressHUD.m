...
- (void)drawRect:(CGRect)rect {
	...
	//CGContextSetGrayFillColor(context, 0.0f, self.opacity);//137/255.0f,9/255.0f,178/255.0f,1.0f
    CGContextSetRGBFillColor (context, 137/255.0f,9/255.0f,178/255.0f,1.0f);
