...
- (void)setupFloatLabel
{
    ...
    _floatLabel.font =[UIFont systemFontOfSize:13.0f];
    _floatLabel.alpha = 0.0f;
    [_floatLabel setCenter:CGPointMake(_xOrigin, 0.0f)];
    [self addSubview:_floatLabel];
    
    // colors
    _floatLabelPassiveColor = [UIColor DGLightGrayColor];
    _floatLabelActiveColor = [UIColor DGPurpleColor];
...
{
    CGFloat top = [self.text length] ? 15.0f : 0.0f;
